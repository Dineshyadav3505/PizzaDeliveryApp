          ...
          <div className="border-y-[1px] border-zinc-500">
            {state.length > 0 ? (
              state.map((item, index) => (
                item && item.name ? (
                  <div key={index} className="relative my-1 py-2 flex gap-5 w-full">
                      ...
                      <div className="flex lg:h-44 w-full lg:flex-col py-3 space-y-2">
                        <div className="flex w-full lg:flex-col items-center gap-5 justify-between">
                          ...
                          <div className="border-[.5px] px-1 flex justify-center items-center gap-3">
                            ...
                            <p>{item.quantity}</p>
                            <span onClick={() => increment(item)} className='h-4 w-4 flex justify-center items-center cursor-pointer'>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-3">
                          ...
                          {/* Delete */}
                          <span className='absolute top-3 right-3 cursor-pointer' onClick={() => removeItem(item)}>
