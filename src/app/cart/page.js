  ...
  const [data, setData] = useState([
    {
      ...
      sizes: { name: 'Regular',  price: 100 },
      crust:{ name: 'New Hand Tossed', price: 5 },
      quantity: 1,
    }, // Add actual items here
    {}
  ]);
              ...
              state.map((item, index) => (
                ...
                <div className=" relative">
                  <div key={index} className="my-1  py-2 flex gap-5  w-full">
                    <div className="h-36 lg:h-44 flex justify-center items-center shadow-md rounded-md border-zinc-500 border-[0.6px]">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between w-[60%] ">
                      <div className="flex lg:h-44  lg:w-full flex-col lg:space-y-2">
                        ...
                        <p className='text-sm'>Size: {item.sizes.name}</p>
                        <p className='text-sm'>Crust: {item.crust.name}</p>
                      </div>
                      ...
                      <div className="flex lg:h-44 w-full lg:flex-col py-3 space-y-2">
                        <div className="flex w-full lg:flex-col items-center gap-5 justify-between">
                          {/* Price */}
                          <p className='text-base'>Price: {item.sizes.price + item.crust.price} /-</p>

                          {/* Quantity */}
                          <div className=" border-[.5px] px-3 flex justify-center items-center gap-2">
